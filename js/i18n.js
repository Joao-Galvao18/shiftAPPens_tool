...
(function (g) {
  ...
  const en = {
    g: {
      canvas: 'Canvas', place: 'Image placement', mask: 'Silhouette',
      strokes: 'Strokes', art: 'Image treatment', grain: 'Grain', out: 'Export'
    },
    l: {
    ...
    o: {
      ...
      'dm.floyd': 'Floyd–Steinberg', 'dm.noise': 'Random noise',
  ...
  const pt = {
    g: {
      canvas: 'Tela', place: 'Posicionamento da imagem', mask: 'Silhueta',
      strokes: 'Contornos', art: 'Tratamento da imagem', grain: 'Grão', out: 'Exportar'
    },
    l: {
    ...
    o: {
      ...
      'dm.floyd': 'Floyd–Steinberg', 'dm.noise': 'Ruído aleatório',
